...
import { ProjectContextManager, type ContextualizedPaths } from '../src/utils/project-context-manager.js';
import { ProjectDetector, type ProjectMode } from '../src/utils/project-detector.js';
...
describe('ProjectContextManager', () => {
  ...
  describe('project switching', () => {
    ...
    it('should switch to different project', async () => {
      ...
      expect(newContext.paths.projectRoot).toBe(
        path.join(testProjectRoot, 'projects', 'project2')
      );
    });
  ...
  describe('context queries', () => {
    ...
    it('should return contextualized paths', () => {
      ...
      expect(paths.configDir).toBe(path.join(testProjectRoot, 'projects', 'project1', '.ai-trackdown'));
  ...
  describe('context validation', () => {
    ...
    it('should detect missing directories as warnings', async () => {
      ...
      expect(validation.warnings.some(w => w.includes('Required directory does not exist'))).toBe(true);
    });
  ...
  describe('context information display', () => {
    it('should display single-project context info', async () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Project Context Information'));
